...
setup(name='ipngnc',
      ...
      long_description = "Slightly modified ncclient 0.4.2!",
      author="Shikhar Bhushan, Leonidas Poulopoulos, Ebben Aries, extended by David Gee",
      author_email="shikhar@schmizz.net, leopoul@noc.grnet.gr, earies@juniper.net, david.gee@ipengineer.net",
      url="http://github.com/davidjohngee/ipng_ncclient",
